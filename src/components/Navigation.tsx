...
const Navigation = () => {
  ...
  return (
    <nav className="relative z-50 bg-black/95 backdrop-blur-sm border-b border-red-500/20">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-lg text-gray-400 hover:text-red-400 hover:bg-gray-800 transition-colors duration-300"
            >
      ...
      {/* Mobile Navigation */}
      {isOpen && (
        <div className="md:hidden absolute top-16 inset-x-0 bg-black/98 backdrop-blur-sm border-b border-red-500/20">
